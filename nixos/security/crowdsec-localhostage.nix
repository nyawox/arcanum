  ...
  content = {
    ...
    services.crowdsec-firewall-bouncer = {
      ...
      settings = {
        log_mode = "stdout";
        mode = "nftables";
        api_key = ''''${LOCALHOSTAGE_FIREWALL_APIKEY}'';
    ...
    systemd = {
      services = {
        ...
        crowdsec-firewall-bouncer = {
          ...
          serviceConfig.EnvironmentFile = config.sops.secrets.crowdsec-localhostage-fwenv.path;
        };
      };
      tmpfiles.rules = [
    ...
    sops.secrets = {
      crowdsec-localhostage-secrets = {
        sopsFile = "${arcanum.secretPath}/crowdsec-localhostage.yaml";
        owner = "crowdsec";
        format = "yaml";
      };
      crowdsec-localhostage-fwenv = {
        sopsFile = "${arcanum.secretPath}/crowdsec-localhostage.yaml";
        owner = "crowdsec";
        format = "yaml";
      };
